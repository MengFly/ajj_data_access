...
public class StressDataInfo{
	...
	public String toString() {
		return "StressDataInfo [acquisitionTime=" + acquisitionTime + ", mpName=" + mpName + ", areaId=" + areaId
				+ ", pValue=" + pValue + ", x=" + x + ", y=" + y + ", z=" + z + ", warnStatus=" + warnStatus
				+ ", redValue=" + redValue + ", yellowValue=" + yellowValue + ", distance=" + distance + ", memo="
				+ memo + ", mpId=" + mpId + ", dayIncreaseIndex=" + dayIncreaseIndex + ", zsIndex=" + zsIndex
				+ ", zfIndex=" + zfIndex + ", singleIndex=" + singleIndex + ", depth=" + depth + ", pIndex=" + pIndex
				+ "]";
	}
